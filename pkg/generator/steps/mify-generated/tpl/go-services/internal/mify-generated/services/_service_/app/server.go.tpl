...
type ServerConf struct {
	ServerEndpoint string `envconfig:"{{.Service.ApiEndpointEnv}}" default:"{{.Service.ApiEndpoint}}"`
	MaintenanceEndpoint string `envconfig:"{{.Service.MaintenanceEndpointEnv}}" default:"{{.Service.MaintenanceEndpoint}}"`
}
